...
type SEWebringProps = HTMLProps<SVGSVGElement>;

const SEWebring = forwardRef<SVGSVGElement, SEWebringProps>((props, ref) => {
  const className =
    (props.className ?? "") +
    " inline-block box-content overflow-visible scale-90 h-4 align-[-0.1328125em] md:align-[-0.1em] -ml-0.5";

  return (
    <svg ref={ref} viewBox="80 200 800 560" {...props} className={className}>
      <path
        fill="currentColor"
        fillRule="evenodd"
        clipRule="evenodd"
